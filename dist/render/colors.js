...
export function stats(text, colors) {
...
export function contextColor(percent, colors, warn = 70, crit = 90) {
    if (percent >= crit)
...
export function colorByPercent(text, percent, colors, warn = 70, crit = 90) {
    return colorize(text, contextColor(percent, colors, warn, crit));
}
export function bar(percent, width = 10, colors, warn = 70, crit = 90) {
