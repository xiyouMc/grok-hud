export declare const en: {
    ...
    readonly 'label.latency': "TTFT";
    readonly 'label.lines': "Lines";
    readonly 'label.session': "Session";
    readonly 'label.live': "live";
    readonly 'label.stale': "stale";
    readonly 'label.noSessions': "No Grok sessions found";
    readonly 'label.inactiveHint': "Start grok or pass --cwd / --session";
